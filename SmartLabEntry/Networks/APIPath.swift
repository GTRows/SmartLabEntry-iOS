...
struct ApiPath {
    ...
    //    static let baseUrl = "http://192.168.5.105:8080/api"
    ...
    // ACCESS PORTALS API
    private static let accessPath = "/access-portals"
    ...
    // image api
    private static let imagePath = "/image"
    static let getImageList = "\(imagePath)/get-image-list"
    static let getImage = "\(imagePath)/get-image"

    // ADMIN API
    private static let adminPath = "/admin"
